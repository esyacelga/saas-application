package com.gymadmin.core.domain.validation;

/**
 * Validación de cédula de identidad ecuatoriana (algoritmo del Registro Civil / módulo 10).
 *
 * Réplica exacta de la frontera del frontend {@code src/lib/sri/validarCedula.ts},
 * {@code platform-service} {@code domain/validation/CedulaEcuatoriana.java} y
 * {@code auth-service} {@code domain/validation/CedulaEcuatoriana.java}: front y los tres
 * backends deben dar el MISMO veredicto para la misma cédula. Si se cambia una copia,
 * cambiar todas.
 *
 * Reglas:
 *  - 10 dígitos exactos.
