...
| [estado-pago-membresias.md](requirements/estado-pago-membresias.md) | HU planeada: separar venta y pago en `core.membresias` con `estado_pago` (`PENDIENTE`/`PAGADO`), soft-delete para rechazos, bloqueo en `validar-acceso`, sección "Ventas pendientes" en admin. |
